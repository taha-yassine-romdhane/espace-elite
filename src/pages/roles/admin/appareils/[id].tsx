...
import { DeviceActions } from '@/components/medicalDevice/DeviceActions';
...
export default function MedicalDeviceDetail({ device }: MedicalDeviceDetailProps) {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-3xl font-bold">Détails de l'appareil</h1>
      </div>
