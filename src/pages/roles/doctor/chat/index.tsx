...
const DoctorChat: React.FC = () => {
        ...
        return (
            <div className="p-6 flex items-center justify-center min-h-screen">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-red-700">Chargement des messages...</span>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="p-6">
            <div className="flex h-[calc(100vh-8rem)] bg-white rounded-lg border border-red-200 overflow-hidden">
                {/* Conversations List */}
                <div className="w-1/3 border-r border-red-200 flex flex-col">
                    {/* Header */}
                        ...
                        {conversations.length > 0 ? (
                            conversations.map((conversation) => (
                                <div
                                    ...
                                    className={cn(
                                        "p-4 border-b border-red-100 cursor-pointer hover:bg-red-50 transition-colors",
                                        selectedConversation?.conversationId === conversation.conversationId && "bg-red-50 border-r-2 border-r-red-500"
                                    )}
                                >
                                    ...
                                    {filteredUsers.length > 0 ? (
                                        filteredUsers.map((user) => (
                                            <div
                                                ...
                                                className="flex items-center space-x-3 p-3 rounded-lg hover:bg-red-50 cursor-pointer transition-colors"
                                            >
                                                <Avatar className="h-8 w-8">
                                                    <AvatarFallback className="bg-gray-200 text-gray-700">
