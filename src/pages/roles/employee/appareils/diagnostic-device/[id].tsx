...
interface DiagnosticDeviceDetailProps {
...
function DiagnosticDeviceDetail({ device }: DiagnosticDeviceDetailProps) {
...
DiagnosticDeviceDetail.getLayout = (page: React.ReactNode) => (
  <EmployeeLayout>{page}</EmployeeLayout>
);

export default DiagnosticDeviceDetail;
