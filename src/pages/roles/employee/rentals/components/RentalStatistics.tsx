...
export default function RentalStatistics() {
  ...
  const tableContent = useMemo(() => (
    <>
      ...
      {/* Table */}
      <div className="rounded-lg border-2 border-green-200 overflow-hidden shadow-lg">
                  ...
                  return (
                    <tr
                      ...
                      className={`hover:bg-green-50 transition-colors ${
                        isEditing ? 'bg-green-100 border-2 border-green-300' : ''
                      }`}
                    >
                      {/* Patient */}
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="text-sm">
                          ...
                          {stat.patientPhone !== '-' && (
                            <div className="text-xs text-green-600">Tel: {stat.patientPhone}</div>
                          )}
      ...
      <div className="space-y-4">
        ...
        <Card className="p-3 bg-green-50 border-green-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-sm font-semibold text-green-900">Filtres</h3>
            <Button
              variant="ghost"
              size="sm"
              onClick={clearAllFilters}
              className="ml-auto text-green-600 hover:text-green-700 h-7 px-2 text-xs"
            >
      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-50 bg-white overflow-auto">
          <div className="min-h-screen p-8">
            ...
            <div className="flex items-center gap-4 mb-6 sticky top-0 bg-white py-4 border-b-2 border-green-200 z-10">
              <div className="flex-1">
                <div className="relative">
                  <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-slate-400" />
                  <Input
