...
export default function ModernTasksPage() {
  ...
  const renderTaskCard = (task: ComprehensiveTask, isCompact = false) => {
    const config = taskTypeConfig[task.type] || taskTypeConfig.TASK; // Fallback to TASK if type is undefined
      ...
      <div className="space-y-4">
        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-4">
            ...
            {isToday && (
              <Badge className="bg-green-500">Aujourd'hui</Badge>
            )}
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-center">
              <p className="text-lg font-bold text-green-600">{tasksByStatus.IN_PROGRESS.length}</p>
            ...
            {tasksByStatus.IN_PROGRESS.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-2 px-2">
                  ...
                  <h3 className="text-sm font-semibold text-green-600">En cours</h3>
      ...
      <Dialog open={isDetailsDialogOpen} onOpenChange={setIsDetailsDialogOpen}>
        <DialogContent className="max-w-xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-3 py-2">
            ...
            {/* Notes Section - Editable for TASK and APPOINTMENT_REMINDER */}
