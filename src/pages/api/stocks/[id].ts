    ...
    case 'PUT':
      try {
        ...
        if (quantity !== undefined) {
          ...
          // Only auto-update if status is not explicitly provided
          if (!status) {
            if (newQuantity > 0) {
        ...
        console.log('Stock updated successfully:', updatedStock.id, 'Quantity:', updatedStock.quantity, 'Status:', updatedStock.status);
