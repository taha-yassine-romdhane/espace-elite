...
export const config = {
  matcher: [
     ...
     * - api/settings/general (public company info)
     * - api/upload-public (public logo uploads)
     */
    '/((?!_next/static|_next/image|favicon.ico|\\.jpg|\\.png|\\.svg|\\.ico|api/auth|api/settings/general|api/upload-public).*)',
  ],
};