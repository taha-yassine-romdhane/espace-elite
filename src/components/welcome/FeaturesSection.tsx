      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Espace Elite intègre tous les outils nécessaires pour optimiser votre pratique médicale, 
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Découvrez toutes les fonctionnalités qui font d'Espace Elite la solution de référence
            </p>
          </div>
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Espace Elite s'intègre parfaitement avec vos outils existants et respecte 
