...
import { FileText, User, AlertCircle, Calendar, Stethoscope } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
interface CompleteDiagnosticDialogProps {
  open: boolean;
...
export function CompleteDiagnosticDialog({ open, onOpenChange }: CompleteDiagnosticDialogProps) {
  ...
  // Fetch PENDING diagnostics for current user
